...
func test_double_scene():
	...
	scene_double.stub("A", "execute", {}, "SUCCESS")
	print(scene_double.instance.get_node("A").execute())
#	scene_double.instance.get_node(".").test()
	print(scene_double.instance.test()) # root isn't being doubled
...
func get_retval(method, arguments):
	return "success"