...
func test_func_methods_returns_an_array_of_only_method_names_beginning_with_test_when_test_method_prefix_is_test():
	context("function VALIDATE.methods() returns an array of only method names beginning with test when test method prefix is 'test'")
	# Arrange
...
func test_func_tests_returns_an_array_of_only_test_filepaths_beginning_with_test_when_test_prefixes_only_includes_test():
	context("function VALIDATE.tests() returns an array of only test filepaths beginning with 'test' when test prefixes only includes test (ie ['test'])'")
	# Arrange
