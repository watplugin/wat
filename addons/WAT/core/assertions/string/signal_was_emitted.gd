...
static func signal_was_emitted(emitter, event: String, context: String) -> AssertionResult:
...
static func signal_was_not_emitted(emitter, _signal: String, context: String) -> AssertionResult:
...
static func signal_was_emitted_x_times(emitter, event: String, times: int, context: String) -> AssertionResult:
...
static func signal_was_emitted_with_args(emitter: Object, event: String, arguments: Array, context: String) -> AssertionResult:
