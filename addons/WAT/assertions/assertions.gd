...
func object_is_connected(sender: Object, _signal: String, receiver: Object, method: String, context: String, crash_on_failure: bool = false) -> void:
	output(_Object.IsConnected.new(sender, _signal, receiver, method, context), crash_on_failure)
...
func object_does_not_have_user_signal(obj, _signal: String, context: String, crash_on_failure: bool = false) -> void:
	output(_Object.DoesNotHaveUserSignal.new(obj, _signal, context), crash_on_failure)
