...
signal OUTPUT
const _IS_TRUE = preload("is_true.gd")
const _IS_FALSE = preload("is_false.gd")
const _IS_EQUAL = preload("is_equal.gd")
const _IS_NOT_EQUAL = preload("is_not_equal.gd")
const _IS_EQUAL_OR_GREATER_THAN = preload("is_equal_or_greater_than.gd")
const _IS_EQUAL_OR_LESS_THAN = preload("is_equal_or_less_than.gd")
const _IS_GREATER_THAN = preload("is_greater_than.gd")
const _IS_LESS_THAN = preload("is_less_than.gd")
const _IS_IN_RANGE = preload("is_in_range.gd")
const _IS_NOT_IN_RANGE = preload("is_not_in_range.gd")
const _IS_CLASS_INSTANCE = preload("is_class_instance.gd")
const _IS_NOT_CLASS_INSTANCE = preload("is_not_class_instance.gd")
const _IS_BUILT_IN_TYPE = preload("is_built_in_type.gd")
const _IS_NOT_BUILT_IN_TYPE = preload("is_not_built_in_type.gd")
const _HAS = preload("has.gd")
const _DOES_NOT_HAVE = preload("does_not_have.gd")
const _IS_NULL = preload("is_null.gd")
const _IS_NOT_NULL = preload("is_not_null.gd")
const _STRING_BEGINS_WITH = preload("string_begins_with.gd")
const _STRING_CONTAINS = preload("string_contains.gd")
const _STRING_ENDS_WITH = preload("string_ends_with.gd")
const _STRING_DOES_NOT_BEGIN_WITH = preload("string_does_not_begin_with.gd")
const _STRING_DOES_NOT_END_WITH = preload("string_does_not_end_with.gd")
const _STRING_DOES_NOT_CONTAIN = preload("string_does_not_contain.gd")
const _SCENE_WAS_CALLED = preload("scene_was_called.gd")
const _SCENE_WAS_NOT_CALLED = preload("scene_was_not_called.gd")
const _SCRIPT_WAS_CALLED = preload("script_was_called.gd")
const _SCRIPT_WAS_NOT_CALLED = preload("script_was_not_called.gd")
const _SIGNAL_WAS_EMITTED = preload("signal_was_emitted.gd")
const _SIGNAL_WAS_NOT_EMITTED = preload("signal_was_not_emitted.gd")
const _CALLED_WITH_ARGUMENTS = preload("called_with_arguments.gd")
