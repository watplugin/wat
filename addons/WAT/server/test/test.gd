...
var recorder: Script = preload("res://addons/WAT/server/test/recorder.gd")
var any: Script = preload("res://addons/WAT/server/test/any.gd")
...
func setup(directory = "", filepath = "", methods = []):
	_methods = methods
	_case = preload("res://addons/WAT/server/test/case.gd").new(directory, filepath, title(), self)
	return self
...
func _ready() -> void:
	...
	_parameters = preload("res://addons/WAT/server/test/parameters.gd").new()
	_watcher = preload("res://addons/WAT/server/test/watcher.gd").new()
	_registry = preload("res://addons/WAT/double/registry.gd").new()
	_yielder = preload("res://addons/WAT/server/test/yielder.gd").new()
